...
/*
	Ввести целочисленный двумерный массив A[N][M], вывести его. Найти максимальный и  минимальный элементы массива, среди тех,
	значения которых кратны двум. Найденные элементы удвоить, а все остальные утроить.
*/
int main()
{
